   ...
   return (
      <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
         <CardContent className="p-6">
            ...
            {(label === 'In Progress' || label === 'Completed') && value > 0 && (
               <div className="mt-4">
                  ...
                  <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                     <div
                        className={`h-full rounded-full ${label === 'In Progress' ? 'bg-amber-500' : 'bg-emerald-500'}`}
...
export default function COWStats({ stats }) {
   const { total = 0, planned = 0, inProgress = 0, completed = 0 } = stats;
